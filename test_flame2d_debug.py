...
if __name__ == "__main__":
    try:
        ...
        print("This is expected due to import complexities, but the debug code is in place")
        print("The flame2d debug will work when run in the actual LedFx environment")
