        ...
        try:
            ...
            if current_time - last_report >= 1.0:
                try:
                    ...
                    print(f"Frame {frame_count}: RustFlame particles - Low: {particle_counts[0]}, "
...
def main():
    ...
    print("\n=== Debug Test Complete ===")
    print("This demonstrates the particle count tracking that will also work in the rusty2d effect")
