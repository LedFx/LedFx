...
class RainAudioEffect(AudioReactiveEffect):
    ...
    CONFIG_SCHEMA = vol.Schema({
        ...
        vol.Optional('lows_sensitivity', description='Sensitivity to low sounds', default = 0.05): vol.All(vol.Coerce(float), vol.Range(min=0.0, max=1.0)),
        vol.Optional('mids_sensitivity', description='Sensitivity to mid sounds', default = 0.05): vol.All(vol.Coerce(float), vol.Range(min=0.0, max=1.0)),
        vol.Optional('high_sensitivity', description='Sensitivity to high sounds', default = 0.05): vol.All(vol.Coerce(float), vol.Range(min=0.0, max=1.0)),
