...
class Water(AudioReactiveEffect, HSVEffect):
    ...
    def audio_data_updated(self, data):
        ...
        self._drops_queue.put((self.pixel_count // 2, intensities[0] * self._config["bass_size"]))
        self._drops_queue.put((self.pixel_count - 2, intensities[0] * self._config["bass_size"]))
        ...
        for i in range(0, len(self._mids_emitters)):
            ...
            self._drops_queue.put((pos, intensities[1] * self._config["mids_size"]))
        ...
        for i in range(0, len(self._high_emitters)):
            ...
            self._drops_queue.put((pos, intensities[2] * self._config["high_size"]))
