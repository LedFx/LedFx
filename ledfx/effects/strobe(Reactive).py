...
class Strobe(AudioReactiveEffect):
    ...
    NAME = "Strobe"
    CONFIG_SCHEMA = vol.Schema({vol.Optional('color',
                                             description='Strobe colour',
                                             default="white"): vol.In(list(COLORS.keys())),
                                vol.Optional('frequency',
                                             description='Strobe frequency',
                                             default="1/16 (◉﹏◉ )"): vol.In(list(["1/2 (.-. )",
                                                                                  "1/4 (.o. )",
                                                                                  "1/8 (◉◡◉ )",
                                                                                  "1/16 (◉﹏◉ )",
                                                                                  "1/32 (⊙▃⊙ )"]))})
    ...
    def audio_data_updated(self, data):
        beat_oscillator = data.oscillator()
