    ...
    "gifplayer": {
        "dj-bird": {
            "config": {
                ...
                "rotate": 0,
                "test": False,
                "url source": f"{os.path.join(LEDFX_ASSETS_PATH, 'gifs', 'pixelart', 'dj_bird.gif')}",
            },
            "name": "DJ Bird",
        },
        "rainbow-moon": {
            "config": {
                ...
                "rotate": 0,
                "test": False,
                "url source": f"{os.path.join(LEDFX_ASSETS_PATH, 'gifs', 'pixelart', 'moon_rainbow.gif')}",
            },
            "name": "Rainbow Moon",
        },
        "fireworks": {
            "config": {
                ...
                "rotate": 0,
                "test": False,
                "url source": f"{os.path.join(LEDFX_ASSETS_PATH, 'gifs', 'pixelart', 'fireworks.gif')}",
            },
            "name": "Fireworks",
        },
        "wled-akemi": {
            "config": {
                ...
                "rotate": 0,
                "test": False,
                "url source": f"{os.path.join(LEDFX_ASSETS_PATH, 'gifs', 'pixelart', 'akemi_resized.gif')}",
            },
            "name": "WLED Akemi",
        },
        ...
        "chicken": {
            "config": {
                ...
                "rotate": 0,
                "test": False,
                "url source": f"{os.path.join(LEDFX_ASSETS_PATH, 'gifs', 'pixelart', 'chicken.gif')}",
            },
            "name": "Chicken",
        },
        "reset": {
