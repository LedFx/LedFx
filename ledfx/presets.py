    ...
    "keybeat2d": {
        ...
        "blade": {
            "config": {
                ...
                "force_aspect": True,
                "force_fit": True,
                "git_at": f"{os.path.join(LEDFX_ASSETS_PATH, 'gifs', 'blade_small.gif')}",
                "gradient": "linear-gradient(90deg, rgb(255, 0, 0) 0%, rgb(255, 120, 0) 14%, rgb(255, 200, 0) 28%, rgb(0, 255, 0) 42%, rgb(0, 199, 140) 56%, rgb(0, 0, 255) 70%, rgb(128, 0, 128) 84%, rgb(255, 0, 178) 98%)",
                "gradient_roll": 0.0,
                "half_beat": True,
                "mirror": False,
        ...
        "bruce": {
            "config": {
                ...
                "force_aspect": True,
                "force_fit": True,
                "git_at": f"{os.path.join(LEDFX_ASSETS_PATH, 'gifs', 'bruces1.gif')}",
                "gradient": "linear-gradient(90deg, rgb(255, 0, 0) 0%, rgb(255, 120, 0) 14%, rgb(255, 200, 0) 28%, rgb(0, 255, 0) 42%, rgb(0, 199, 140) 56%, rgb(0, 0, 255) 70%, rgb(128, 0, 128) 84%, rgb(255, 0, 178) 98%)",
                "gradient_roll": 0.0,
                "mirror": False,
                "ping_pong": True,
        ...
        "bumble": {
            "config": {
                ...
                "force_aspect": False,
                "force_fit": False,
                "git_at": f"{os.path.join(LEDFX_ASSETS_PATH, 'gifs', 'bumble.gif')}",
                "gradient": "linear-gradient(90deg, rgb(255, 0, 0) 0%, rgb(255, 120, 0) 14%, rgb(255, 200, 0) 28%, rgb(0, 255, 0) 42%, rgb(0, 199, 140) 56%, rgb(0, 0, 255) 70%, rgb(128, 0, 128) 84%, rgb(255, 0, 178) 98%)",
                "gradient_roll": 0.0,
                "mirror": False,
                "ping_pong": True,
        ...
        "dance": {
            "config": {
                ...
                "force_aspect": True,
                "force_fit": True,
                "git_at": f"{os.path.join(LEDFX_ASSETS_PATH, 'gifs', 'dancing.gif')}",
                "gradient": "linear-gradient(90deg, rgb(255, 0, 0) 0%, rgb(255, 120, 0) 14%, rgb(255, 200, 0) 28%, rgb(0, 255, 0) 42%, rgb(0, 199, 140) 56%, rgb(0, 0, 255) 70%, rgb(128, 0, 128) 84%, rgb(255, 0, 178) 98%)",
                "gradient_roll": 0.0,
                "mirror": False,
                "ping_pong": False,
        ...
        "dj bird": {
            "config": {
                ...
                "force_aspect": False,
                "force_fit": True,
                "git_at": f"{os.path.join(LEDFX_ASSETS_PATH, 'gifs', 'pixelart', 'dj_bird.gif')}",
                "gradient": "linear-gradient(90deg, rgb(255, 0, 0) 0%, rgb(255, 120, 0) 14%, rgb(255, 200, 0) 28%, rgb(0, 255, 0) 42%, rgb(0, 199, 140) 56%, rgb(0, 0, 255) 70%, rgb(128, 0, 128) 84%, rgb(255, 0, 178) 98%)",
                "gradient_roll": 0.0,
                "half_beat": False,
                "pp_skip": False,
        ...
        "moonman": {
            "config": {
                ...
                "force_aspect": True,
                "force_fit": True,
                "git_at": f"{os.path.join(LEDFX_ASSETS_PATH, 'gifs', 'moonman.gif')}",
                "gradient": "linear-gradient(90deg, rgb(255, 0, 0) 0%, rgb(255, 120, 0) 14%, rgb(255, 200, 0) 28%, rgb(0, 255, 0) 42%, rgb(0, 199, 140) 56%, rgb(0, 0, 255) 70%, rgb(128, 0, 128) 84%, rgb(255, 0, 178) 98%)",
                "gradient_roll": 0,
                "mirror": False,
                "ping_pong": True,
        ...
        "nyan": {
            "config": {
                ...
                "force_aspect": False,
                "force_fit": True,
                "git_at": f"{os.path.join(LEDFX_ASSETS_PATH, 'gifs', 'cat-space.gif')}",
                "gradient": "linear-gradient(90deg, rgb(255, 0, 0) 0%, rgb(255, 120, 0) 14%, rgb(255, 200, 0) 28%, rgb(0, 255, 0) 42%, rgb(0, 199, 140) 56%, rgb(0, 0, 255) 70%, rgb(128, 0, 128) 84%, rgb(255, 0, 178) 98%)",
                "gradient_roll": 0.0,
                "mirror": False,
                "ping_pong": False,
        ...
        "phoebe": {
            "config": {
                ...
                "force_aspect": False,
                "force_fit": False,
                "git_at": f"{os.path.join(LEDFX_ASSETS_PATH, 'gifs', 'phoebe.gif')}",
                "gradient": "linear-gradient(90deg, rgb(255, 0, 0) 0%, rgb(255, 120, 0) 14%, rgb(255, 200, 0) 28%, rgb(0, 255, 0) 42%, rgb(0, 199, 140) 56%, rgb(0, 0, 255) 70%, rgb(128, 0, 128) 84%, rgb(255, 0, 178) 98%)",
                "gradient_roll": 0.0,
                "mirror": False,
                "ping_pong": True,
        ...
        "snoopy": {
            "config": {
                ...
                "force_aspect": False,
                "force_fit": True,
                "git_at": f"{os.path.join(LEDFX_ASSETS_PATH, 'gifs', 'snoopy.gif')}",
                "gradient": "linear-gradient(90deg, rgb(255, 0, 0) 0%, rgb(255, 120, 0) 14%, rgb(255, 200, 0) 28%, rgb(0, 255, 0) 42%, rgb(0, 199, 140) 56%, rgb(0, 0, 255) 70%, rgb(128, 0, 128) 84%, rgb(255, 0, 178) 98%)",
                "gradient_roll": 0.0,
                "mirror": False,
                "ping_pong": False,
        ...
        "sponge": {
            "config": {
                ...
                "force_aspect": True,
                "force_fit": True,
                "git_at": f"{os.path.join(LEDFX_ASSETS_PATH, 'gifs', 'sponge.gif')}",
                "gradient": "linear-gradient(90deg, rgb(255, 0, 0) 0%, rgb(255, 120, 0) 14%, rgb(255, 200, 0) 28%, rgb(0, 255, 0) 42%, rgb(0, 199, 140) 56%, rgb(0, 0, 255) 70%, rgb(128, 0, 128) 84%, rgb(255, 0, 178) 98%)",
                "gradient_roll": 0.0,
                "mirror": False,
                "ping_pong": False,
        ...
        "zilla": {
            "config": {
                ...
                "force_aspect": True,
                "force_fit": True,
                "git_at": f"{os.path.join(LEDFX_ASSETS_PATH, 'gifs', 'zilla1.gif')}",
                "gradient": "linear-gradient(90deg, rgb(255, 0, 0) 0%, rgb(255, 120, 0) 14%, rgb(255, 200, 0) 28%, rgb(0, 255, 0) 42%, rgb(0, 199, 140) 56%, rgb(0, 0, 255) 70%, rgb(128, 0, 128) 84%, rgb(255, 0, 178) 98%)",
                "gradient_roll": 0.0,
                "mirror": False,
                "ping_pong": False,
