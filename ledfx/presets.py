    ...
    "random_spotlight": {
        "club-smooth": {
            "config": {
                ...
                "lows_weight": 0.85,
                "max_active_spots": 34,
                "max_spawns_per_update": 7,
                "mids_weight": 1.0,
                "min_active_spots": 5,
                "min_time_between_spots": 0.012,
                "peak_spawn_boost": 2.2,
                "spot_color_span": 0.1,
                "spot_width": 17,
                "transient_sensitivity": 1.1,
                "use_gradient": True,
            },
            "name": "Club Smooth",
        },
        "club-drop-max": {
            "config": {
                ...
                "lows_weight": 1.0,
                "max_active_spots": 96,
                "max_spawns_per_update": 14,
                "mids_weight": 1.0,
                "min_active_spots": 8,
                "min_time_between_spots": 0.004,
                "peak_spawn_boost": 6.5,
        ...
        "small-spotlights": {
            "config": {
                ...
                "max_spawns_per_update": 6,
                "mids_weight": 1.0,
                "min_active_spots": 3,
                "min_time_between_spots": 0.01,
                "peak_spawn_boost": 1.8,
    ...
    "concentric": {
        "fire-explosion": {
            "config": {
                ...
                "flip_vertical": False,
                "frequency_range": "Lows (beat+bass)",
                "gradient": "linear-gradient(90deg, #ff00b2 0.00%,#ff2800 24.00%,#ff8f00 50.00%,#ff0000 75.00%,#ff00dd 100.00%)",
                "gradient_roll": 0.0,
                "gradient_scale": 1.7,
                "idle_speed": 0.5,
                "invert": False,
        ...
        "ocean-implosion": {
            "config": {
                ...
                "flip_vertical": False,
                "frequency_range": "Lows (beat+bass)",
                "gradient": "linear-gradient(90deg, #00ffff 0.00%,#0000ff 42.00%,#0000ff 60.00%,#00b8d6 98.00%)",
                "gradient_roll": 0.0,
                "gradient_scale": 1.5,
                "idle_speed": 0.29,
                "invert": True,
