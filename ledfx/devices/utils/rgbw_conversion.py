...
def rgb_to_rgbw(rgb_array, white_channel_computation=WhiteChannelComputation.ACCURATE):
    """
    ...
    if white_channel_computation == WhiteChannelComputation.NONE:
        ...
        raise ValueError(f"Unknown white channel computation method: {white_channel_computation}")
