...
class LaunchpadDevice(MidiDevice):
    ...
    # def onAfterDeviceAdded():
    # # def onAfterDeviceAdded(self, device_config, device):
    #     _LOGGER.info("HACKED BY Y LP-after")
    # if device_config["create_segments"] or self.config["create_segments"]:
