...
class TestLedFx:
    ...
    def test_navigation_and_about(self, page: Page, ledfx_server):
        ...
        page.screenshot(
            path="tests/e2e/screenshots/01_homepage.png", full_page=True
        )
        ...
        time.sleep(1)
        page.screenshot(
            path="tests/e2e/screenshots/02_after_skip.png", full_page=True
        )
        ...
        time.sleep(1)
        page.screenshot(
            path="tests/e2e/screenshots/03_settings.png", full_page=True
        )
        ...
        time.sleep(1)
        page.screenshot(
            path="tests/e2e/screenshots/04_general.png", full_page=True
        )
        ...
        time.sleep(1)
        page.screenshot(
            path="tests/e2e/screenshots/05_about.png", full_page=True
        )
        ...
        assert (major, minor, patch) >= (
            ...
            1,
            2,
        ), f"Version {version_match.group()} is below minimum 2.1.2"
