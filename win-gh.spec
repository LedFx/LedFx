...
a = Analysis([f'{spec_root}/ledfx/__main__.py'],
             ...
             binaries=[],
             datas=[(f'{spec_root}/ledfx_frontend', 'ledfx_frontend/'), (f'{spec_root}/ledfx/', 'ledfx/'), (f'{spec_root}/assets', 'assets/'),(f'{spec_root}/assets/tray.png','.')],
...
exe = EXE(pyz,
          ...
          upx=True,
          console=False,
          icon=f'{spec_root}/assets/discord.ico')
coll = COLLECT(exe,
               a.binaries,
               a.zipfiles,
               a.datas,
