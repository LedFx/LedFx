...
a = Analysis([f'{spec_root}\\ledfx\\__main__.py'],
             ...
             binaries=[],
             datas=[(f'{spec_root}/ledfx_frontend', 'ledfx_frontend/'), (f'{spec_root}/ledfx/', 'ledfx/'), (f'{spec_root}/icons', 'icons/')],
             ...
             'sentry_sdk.integrations.boto3','_cffi_backend','serial','pystray'],
