...
5. If the browser tab with BG Visualiser loses focus to another tab in the host browser, or if the browser is minimised, the BG Visuliser effect stops rendering until focus is regained.
