...
LedFx documentation builds should be run with Python 3.10 through 3.13 (the supported project range from `pyproject.toml`). Python versions outside this range are explicitly unsupported and may result in non-deterministic failures.
